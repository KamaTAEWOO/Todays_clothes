...
public class MyClosetBottom extends MainWeatherPage {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_closet_bottom);
    ...
    {
        prefs=this.getSharedPreferences("ClothesBottom", Context.MODE_PRIVATE);
        ...
        findViewById(R.id.btn_delete).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    SharedPreferences pref = getApplicationContext().getSharedPreferences("ClothesBottom", MODE_PRIVATE);
                    ...
                    if (position == -1) {
                        Toast.makeText(MyClosetBottom.this, R.string.err_no_selected_item, Toast.LENGTH_SHORT).show();
                        return;
                    }
