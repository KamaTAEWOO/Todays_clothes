...
//*******************************************************
    ...
    // 주소를 나눠서 저장
    private String m_location1; // 경상북도
    private String m_location2; // 경산시
    private String m_location3; // 진량읍
...
////            return baseTime;
//        }
        if(m_hour.equals("0200") || m_hour.equals("0300"))
        {
            calBase = Calendar.getInstance(); // 현재시간 가져옴
            calBase.add(Calendar.DATE , -1);
            String beforeDate = new java.text.SimpleDateFormat("yyyyMMdd").format(calBase.getTime());
...
//        // x,y 좌표 들고오기.
        for (int i = 0; i < (m_count-1); i++ ){
            ...
            if(location.name3.equals(m_location3)) {
